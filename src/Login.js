...
import { emailValidate, passwordValidate } from "../src/utils-form-validate";
        ...
        <Box mx="1" maxW="md" p="9" borderWidth="1px" borderRadius="lg">
            ...
            <form onSubmit={handleSubmit(handleLogin)}>
                <FormControl isInvalid={errors.email} py="2">
                    ...
                    <Input type="email" placeholder="user@gmail.com" autoComplete="off" {...register('email', emailValidate)}  />
